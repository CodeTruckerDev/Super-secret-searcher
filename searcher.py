...
class Sss():
    ...
    def __init__(self):
        ...
        self.ctd = "codetruckerdev@proton.me"
        numvar = IntVar()
        # losowane liczby parzyste w zakresie od 2 do 50
...
Zapytaj go, czy nadal chce nim zostać {}".format(self.ctd))
            self.root.destroy()
        else:
            messagebox.showerror("WRONG","To nie ta liczba. Wdech, wydech i jeszcze raz!")
            self.root.destroy()
...
'''
Magnifying Glass icon by Icons8 
https://icons8.com/icon/Y6AAeSVIcpWt/search
'''
